...
class MyTrainingPretestController extends Controller
{
    /**
    ...
    public function store(Request $request, MyTrainingEvent $myTrainingEvent)
    {
        ...
        return MyTrainingQuestion::storeRecordPretest($request, $myTrainingEvent);
    }
    ...
    public function update(Request $request, MyTrainingEvent $myTrainingEvent, MyTrainingQuestion $myTrainingQuestion)
    {
        ...
        return MyTrainingQuestion::updateRecordPretest($request, $myTrainingQuestion);
    }

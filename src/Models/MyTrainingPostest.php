...
use Module\MyTraining\Http\Resources\PostestResource;

class MyTrainingPostest extends Model
{
    use Filterable;
    use HasMeta;
    use HasPageSetup;
     ...
     * @var array
     */
    protected $roles = ['mytraining-postest'];
    ...
    {
        static::addGlobalScope('onlyPostest', function (Builder $query) {
            $query->where('mode', 'POSTEST');
        });
    }
    ...
    public static function storeRecord(Request $request)
    {
        ...
        try {
            ...
            return new PostestResource($model);
        } catch (\Exception $e) {
